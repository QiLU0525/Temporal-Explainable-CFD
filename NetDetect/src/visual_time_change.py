...
class Visual(object):
    ...
    def draw(self):
        ...
        self.plt.ylim(0.65, 0.81)

    def save_to_png(self):
        date = str(datetime.datetime.now().date())
        self.plt.figure(1)
        self.plt.savefig(f"images/time_span_{date}.png", bbox_inches='tight', transparent=False, dpi=600, figsize=(50, 50))
        # self.plt.savefig(f"images/early_warning_{date}.png", bbox_inches='tight', transparent=False, dpi=600, figsize=(50, 50))


if __name__ == '__main__':

    file_list = [
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[0]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-1,0]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-2,-1,0]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-3,-2,-1,0]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-4,-3,-2,-1,0]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_512_64_None_2023-06-13'
    ]
    '''
    file_list = [
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-5]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-5,-4]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-5,-4,-3]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-5,-4,-3,-2]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-5,-4,-3,-2,-1]_512_64_None_2023-06-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_512_64_None_2023-06-13'
    ]
    '''

    model_list = ['T-0', 'T-1', 'T-2', 'T-3', 'T-4', 'T-5']
    # model_list = ['T-5~T-5', 'T-5~T-4', 'T-5~T-3', 'T-5~T-2', 'T-5~T-1', 'T-5']
