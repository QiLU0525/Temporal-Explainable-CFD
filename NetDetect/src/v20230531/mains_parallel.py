...
if __name__=='__main__':
    ...
    '''
    # seeds = [2023, 2022, 2024, 2025,  2027, 2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029]
    seeds = [2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029]
    run_n_fold(seeds=seeds)

    # save_path = args["log_dir"]
    save_path = 'results/' + 'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[-5]_512_64_None_2023-05-25'
