...
class Visual(object):
    ...
    def draw(self):
        ...
        self.plt.ylim(0.71, 0.73)

    def save_to_png(self):
        date = str(datetime.datetime.now().date())
        self.plt.figure(1)
        # self.plt.savefig(f"images/auc_gru_dim_{date}.png", bbox_inches='tight', transparent=False, dpi=600, figsize=(50, 50))
        self.plt.savefig(f"images/auc_attn_heads_{date}.png", bbox_inches='tight', transparent=False, dpi=600, figsize=(50, 50))
        # self.plt.savefig(f"images/auc_node_dim_{date}.png", bbox_inches='tight', transparent=False, dpi=600, figsize=(50, 50))


if __name__ == '__main__':
    attn_heads = [
        'base-han_5e-05_0.0_0.001_[1, 1]_256_30_[-5,-4,-3,-2,-1,0]_512_64_None_2023-05-15',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_512_64_None_2023-05-18',
        'base-han_5e-05_0.0_0.001_[4, 4]_256_30_[]_512_64_None_2023-05-18',
        'base-han_5e-05_0.0_0.001_[8, 8]_256_30_[]_512_64_None_2023-05-18'
    ]
    gru_output_dim = [
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_64_64_None_2023-05-18',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_128_64_None_2023-05-18',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_256_64_None_2023-05-18',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_512_64_None_2023-05-18',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_1024_64_None_2023-05-18'
    ]
    graph_emb_dim = [
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_512_32_None_2023-05-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_512_64_None_2023-05-18',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_512_128_None_2023-05-19',
        'base-han_5e-05_0.0_0.001_[2, 2]_256_30_[]_512_256_None_2023-05-19'
    ]
