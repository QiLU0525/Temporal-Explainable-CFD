...
if __name__=='__main__':
    ...
    parser.add_argument("-ld", "--log_dir", type=str, default="../../output/results", help="Dir for saving training results")
    ...
    parser.add_argument('--path', type=str, default='total', help='include which path, default total')
    parser.add_argument('--emb_init', type=str, default='None', help='only gat and han will use')
    parser.add_argument('--print_param', type=str, default='None',
                        help='1.gat, 2.path, 3.pred, 4.mlp, 5. None')
    ...
    '''
    # min_seeds = [2020, 2026, 2027, 2031, 2035]
    # seeds = [2021, 2022, 2023, 2024, 2025,  2028, 2029, 2030, 2032, 2033, 2034]
    seeds_1 = [2020, 2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029]
    seeds_2 = [2030, 2031, 2032, 2033, 2034, 2035]
    run_n_fold(seeds=seeds_1 + seeds_2)

    # save_path = args["log_dir"]
    save_path = '../../output/results/' + 'han_5e-05_0.0_0.001_[1, 1]_256_30_[0]_64_64_Normal_2023-06-23'
    # save_path = '../../output/results/' + 'base-han_5e-05_0.0_0.001_[8, 8]_256_30_[]_512_64_None_2023-06-13'
